...
HomeScreenUserListModel homeScreenUserListModelFromJson(String str) => HomeScreenUserListModel.fromJson(json.decode(str));

String homeScreenUserListModelToJson(HomeScreenUserListModel data) => json.encode(data.toJson());

class HomeScreenUserListModel {
  bool success;
  List<HomeScreenUserListModelDatum> data;
  String message;

  HomeScreenUserListModel({
    required this.success,
    required this.data,
    required this.message,
  });

  factory HomeScreenUserListModel.fromJson(Map<String, dynamic> json) => HomeScreenUserListModel(
    success: json["success"]??false,
    data: List<HomeScreenUserListModelDatum>.from(json["data"].map((x) => HomeScreenUserListModelDatum.fromJson(x))),
...
class HomeScreenUserListModelDatum {
  String title;
  List<DatumDatum> data;

  HomeScreenUserListModelDatum({
    required this.title,
    required this.data,
  });

  factory HomeScreenUserListModelDatum.fromJson(Map<String, dynamic> json) => HomeScreenUserListModelDatum(
    title: json["title"],
